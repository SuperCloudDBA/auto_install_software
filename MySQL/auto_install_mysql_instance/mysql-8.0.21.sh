...
[client]
port = 3306
socket = /alidata/mysql/data/mysql.sock
...
slow_query_log_file = /alidata/mysql/slow.log
log-error = /alidata/mysql/error.log
long_query_time = 0.1
...
server-id = 3306
log-bin = /alidata/mysql/data/mybinlog
sync_binlog = 1
...
innodb_undo_directory = /alidata/mysql/data/undolog
